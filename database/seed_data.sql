...
(2, 'Rajesh Nagar (Depalpur Manager)', 'manager.depalpur@smarthealth.gov.in', 'UPDATE_BED', '{"params":{"id":"5"},"body":{"status":"Occupied","bed_number":"B-105","ward_name":"General Ward","health_centre_id":"1"},"response":{}}', NOW() - INTERVAL '2 hours'),
(3, 'Sanjay Gupta (Betma Manager)', 'manager.betma@smarthealth.gov.in', 'UPDATE_DOCTOR_LIVE_STATUS', '{"body":{"is_checked_in":true,"status":"Active"},"params":{},"response":{}}', NOW() - INTERVAL '1 hour 45 minutes'),
(133, 'Sanjay Sharma (PHC Hatod Pharmacist)', 'pharm.hatod@smarthealth.gov.in', 'UPDATE_STOCK', '{"params":{"id":"10"},"body":{"current_stock":150,"min_required_stock":50,"reorder_level":60,"medicine_id":"1","health_centre_id":"7"},"response":{}}', NOW() - INTERVAL '1 hour 30 minutes'),
(1, 'Dr. Anurag Dixit (CMHO)', 'anurag.cmho@smarthealth.gov.in', 'CREATE_MEDICINE', '{"body":{"name":"Amoxicillin 500mg","generic_name":"Amoxicillin","category":"Antibiotics","dosage_form":"Tablet"},"params":{},"response":{}}', NOW() - INTERVAL '1 hour 15 minutes'),
(8, 'Manager PHC PHC Hatod', 'manager.phchatod@smarthealth.gov.in', 'CREATE_TEST', '{"body":{"test_id":"1","daily_capacity":"100","health_centre_id":"7"},"params":{},"response":{}}', NOW() - INTERVAL '45 minutes'),
(133, 'Sanjay Sharma (PHC Hatod Pharmacist)', 'pharm.hatod@smarthealth.gov.in', 'DELETE_STOCK', '{"params":{"id":"893"},"body":{},"response":{"message":"Inventory record deleted successfully.","inventory":{"id":893,"medicine_id":15,"health_centre_id":7,"current_stock":50}}}', NOW() - INTERVAL '30 minutes'),
(8, 'Manager PHC PHC Hatod', 'manager.phchatod@smarthealth.gov.in', 'DELETE_TEST', '{"params":{"id":"12"},"body":{},"response":{"message":"Test availability record deleted successfully.","test":{"id":12,"test_id":3,"health_centre_id":7}}}', NOW() - INTERVAL '15 minutes');
