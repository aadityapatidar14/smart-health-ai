...
(7, 'Manoj Prajapat', '9704050524', 'Sanwer Sector 2', 'Jaundice Diagnosis', 'Admitted', NOW() - INTERVAL '1 days 4 hours', NULL),
(7, 'Asha Vyas', '9680921779', 'Pedmi Village Annexe', 'Acute Gastroenteritis', 'Discharged', NOW() - INTERVAL '4 days 4 hours', NOW() - INTERVAL '1 days 3 hours'),
(3, 'Rekha Soni', '9670985938', 'Betma Road Rural', 'Maternal Labor & Delivery', 'Admitted', NOW() - INTERVAL '4 days 11 hours', NULL),
(16, 'Preeti Chouhan', '9912300475', 'Hatod Main Bazaar', 'Maternal Labor & Delivery', 'Discharged', NOW() - INTERVAL '4 days 6 hours', NOW() - INTERVAL '2 days 13 hours'),
(1, 'Pooja Verma', '9579152734', 'Betma Road Rural', 'Hypertension Crisis', 'Admitted', NOW() - INTERVAL '5 days 13 hours', NULL),
(16, 'Deepak Dave', '9282242377', 'Harsola Sector A', 'Migraine Assessment', 'Admitted', NOW() - INTERVAL '5 days 1 hours', NULL),
(5, 'Dinesh Nagar', '9927025420', 'Palda Industrial Sector', 'Maternal Labor & Delivery', 'Admitted', NOW() - INTERVAL '4 days 7 hours', NULL),
(30, 'Vikram Jha', '9419214440', 'Sanwer Sector 2', 'Typhoid Fever', 'Admitted', NOW() - INTERVAL '2 days 6 hours', NULL),
(31, 'Amit Patel', '9224216324', 'Yashwantnagar Housing Board', 'Minor Burn Treatment', 'Admitted', NOW() - INTERVAL '4 days 10 hours', NULL),
(2, 'Deepak Kumar', '9934002371', 'Rural Hatod Sector B', 'Cardiac Chest Pain Monitoring', 'Admitted', NOW() - INTERVAL '3 days 13 hours', NULL),
(31, 'Gopal Trivedi', '9822944120', 'Vijay Nagar Annexe', 'Asthma Exacerbation', 'Discharged', NOW() - INTERVAL '6 days 4 hours', NOW() - INTERVAL '2 days 18 hours'),
(18, 'Arjun Rao', '9737960153', 'Annadia Rural Annexe', 'Minor Burn Treatment', 'Admitted', NOW() - INTERVAL '1 days 20 hours', NULL),
(31, 'Rajesh Jha', '9131271034', 'Kshipra Sector 3', 'Acute Appendicitis', 'Admitted', NOW() - INTERVAL '2 days 22 hours', NULL),
(1, 'Rekha Vyas', '9239371652', 'Pedmi Village Annexe', 'Typhoid Fever', 'Admitted', NOW() - INTERVAL '1 days 16 hours', NULL),
(12, 'Priya Soni', '9953133369', 'Mangliya Near Station', 'Urinary Tract Infection', 'Admitted', NOW() - INTERVAL '3 days 14 hours', NULL),
(2, 'Vinod Singh', '9888194592', 'Betma Road Rural', 'Dengue Fever Symptoms', 'Admitted', NOW() - INTERVAL '6 days 12 hours', NULL),
(8, 'Seema Trivedi', '9880070397', 'Vijay Nagar Annexe', 'General Weakness/Anemia', 'Admitted', NOW() - INTERVAL '6 days 15 hours', NULL),
(7, 'Ashok Bhatia', '9915475605', 'Manpur Highway Ward 4', 'Post-operative Care', 'Admitted', NOW() - INTERVAL '1 days 6 hours', NULL),
(8, 'Ramesh Joshi', '9545569280', 'Vijay Nagar Annexe', 'Influenza A', 'Admitted', NOW() - INTERVAL '2 days 3 hours', NULL),
(14, 'Maya Rao', '9788545829', 'Kshipra Sector 3', 'Heat Stroke Recovery', 'Admitted', NOW() - INTERVAL '6 days 18 hours', NULL),
(10, 'Manoj Singh', '9934928393', 'Betma Road Rural', 'Acute Gastroenteritis', 'Admitted', NOW() - INTERVAL '1 days 11 hours', NULL),
(7, 'Vinod Joshi', '9161314926', 'Manpur Highway Ward 4', 'Minor Burn Treatment', 'Discharged', NOW() - INTERVAL '1 days 4 hours', NOW() - INTERVAL '0 days 17 hours'),
(2, 'Seema Patel', '9128731899', 'Rangwasa Road Annexe', 'Acute Appendicitis', 'Admitted', NOW() - INTERVAL '3 days 18 hours', NULL),
(16, 'Vijay Pandey', '9537861017', 'Vijay Nagar Annexe', 'High Fever and Malaria', 'Admitted', NOW() - INTERVAL '1 days 14 hours', NULL),
(28, 'Gopal Sen', '9422896401', 'Betma Chowk', 'Maternal Labor & Delivery', 'Admitted', NOW() - INTERVAL '5 days 16 hours', NULL),
(5, 'Mohan Verma', '9994702586', 'Rural Hatod Sector B', 'Migraine Assessment', 'Admitted', NOW() - INTERVAL '1 days 4 hours', NULL),
(28, 'Ramesh Verma', '9106982282', 'Harsola Sector A', 'Acute Gastroenteritis', 'Admitted', NOW() - INTERVAL '2 days 13 hours', NULL),
(7, 'Manoj Yadav', '9917540177', 'Mangliya Near Station', 'Migraine Assessment', 'Discharged', NOW() - INTERVAL '2 days 7 hours', NOW() - INTERVAL '1 days 3 hours'),
(31, 'Ashok Dave', '9167289632', 'Mangliya Near Station', 'Diabetic Ketoacidosis', 'Discharged', NOW() - INTERVAL '4 days 12 hours', NOW() - INTERVAL '0 days 9 hours'),
(2, 'Kavita Joshi', '9938692546', 'Rural Hatod Sector B', 'High Fever and Malaria', 'Discharged', NOW() - INTERVAL '1 days 18 hours', NOW() - INTERVAL '0 days 14 hours'),
(5, 'Manoj Mandloi', '9421036883', 'Annadia Rural Annexe', 'Maternal Labor & Delivery', 'Discharged', NOW() - INTERVAL '2 days 6 hours', NOW() - INTERVAL '0 days 18 hours'),
(12, 'Vijay Bhatia', '9500613977', 'Annadia Rural Annexe', 'Maternal Labor & Delivery', 'Admitted', NOW() - INTERVAL '2 days 8 hours', NULL),
(29, 'Anil Pandey', '9668160505', 'Vijay Nagar Annexe', 'Minor Burn Treatment', 'Admitted', NOW() - INTERVAL '1 days 14 hours', NULL),
(8, 'Neha Mandloi', '9559268611', 'Kampel Road Village', 'Migraine Assessment', 'Admitted', NOW() - INTERVAL '1 days 8 hours', NULL),
(10, 'Sanjay Sen', '9292388683', 'Sanwer Sector 2', 'Jaundice Diagnosis', 'Admitted', NOW() - INTERVAL '4 days 6 hours', NULL),
(18, 'Vinod Jha', '9178307180', 'Manpur Highway Ward 4', 'Post-operative Care', 'Admitted', NOW() - INTERVAL '1 days 6 hours', NULL),
(5, 'Kavita Joshi', '9485189180', 'Hatod Main Bazaar', 'Cardiac Chest Pain Monitoring', 'Discharged', NOW() - INTERVAL '6 days 8 hours', NOW() - INTERVAL '1 days 21 hours'),
(30, 'Rajesh Rao', '9543962793', 'Harsola Sector A', 'Acute Gastroenteritis', 'Admitted', NOW() - INTERVAL '3 days 21 hours', NULL),
(14, 'Maya Rathore', '9285118542', 'Depalpur Ward 3', 'Typhoid Fever', 'Admitted', NOW() - INTERVAL '2 days 1 hours', NULL),
(29, 'Vijay Sharma', '9904659244', 'Vijay Nagar Annexe', 'Acute Bronchitis', 'Admitted', NOW() - INTERVAL '2 days 16 hours', NULL),
(18, 'Asha Jha', '9958867310', 'Annapurna Area', 'Dengue Fever Symptoms', 'Admitted', NOW() - INTERVAL '1 days 18 hours', NULL),
(28, 'Ramesh Jha', '9927953118', 'Kampel Road Village', 'Acute Gastroenteritis', 'Admitted', NOW() - INTERVAL '3 days 6 hours', NULL),
(14, 'Seema Kumar', '9218584699', 'Annapurna Area', 'Hypertension Crisis', 'Admitted', NOW() - INTERVAL '3 days 22 hours', NULL),
(8, 'Ramesh Verma', '9871875627', 'Depalpur Ward 3', 'High Fever and Malaria', 'Admitted', NOW() - INTERVAL '2 days 22 hours', NULL),
(30, 'Priya Nagar', '9366945427', 'Depalpur Ward 3', 'Typhoid Fever', 'Admitted', NOW() - INTERVAL '4 days 17 hours', NULL);
